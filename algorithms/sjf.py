...
# Rules:
#   - At each scheduling decision point, pick the available process with the smallest burst time.
#   - Non-preemptive: once a process starts, it runs to completion.
#   - Ties in burst time are broken by arrival time, then PID.
...
def run_sjf(processes: list[dict]) -> dict:
    """
    Simulates non-preemptive SJF scheduling.
    ...
    while completed < total:
        ...
        # Ties broken by arrival time, then PID (alphabetical)
